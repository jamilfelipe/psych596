...
#incorrect (equivalent to above)  
mrot_tib <- readr::read_csv("data/mentalrotation_bysub_tidy.csv", FALSE) 
#correct  
mrot_tib <- readr::read_csv("data/mentalrotation_bysub_tidy.csv", na = "na")
#also correct, since there are no missing values  
...
effectsize::eta_squared(rt_rm, ci = .95, partial = TRUE, alternative = "two.sided") |>
  knitr::kable(caption = "Effect Size: Partial Eta-squared", digits = 4) 
...
- see the code below for an example of how to generate linear, quadratic, and cubic contrasts for the Angle variable (like in the "Tests of Within Subjects Contrasts" table in SPSS)
- for further explanation see this example at [https://nmmichalak.github.io/nicholas_michalak/blog_entries/2018/nrg07/nrg07.html](https://nmmichalak.github.io/nicholas_michalak/blog_entries/2018/nrg07/nrg07.html)
