...
- here's a [link to the tsv file](../data/Dataset-PublicationStatistics-2024.tsv) if you want to check it out on your own  
```{r import}
...
2. Are the observed deviations from expected frequencies likely under the null hypothesis? (χ<sup>2</sup>(1, N = 306) = -----, p<.0001).  
